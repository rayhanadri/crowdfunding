...
CREATE TABLE "campaigns"."campaigns" (
    ...
    status VARCHAR(50) DEFAULT 'PENDING', -- e.g., ACTIVE, COMPLETED
	category VARCHAR(50),
...
CREATE TABLE "donations"."transactions" (
    id SERIAL PRIMARY KEY,
...
INSERT INTO "campaigns"."campaigns" (user_id, title, description, target_amount, collected_amount, deadline, status, category, min_donation)
VALUES
...
INSERT INTO "donations"."transactions" (
